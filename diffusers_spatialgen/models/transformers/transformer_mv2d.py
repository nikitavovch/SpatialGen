...
from diffusers_spatialgen.models.mv_attention import BasicMVTransformerBlock


# Copied from diffusers.models.transformers.transformer_2d.Transformer2DModel
# The only modificaitons: `BasicTransformerBlock` -> `BasicMVTransformerBlock`
class TransformerMV2DModel(LegacyModelMixin, LegacyConfigMixin):
    """
