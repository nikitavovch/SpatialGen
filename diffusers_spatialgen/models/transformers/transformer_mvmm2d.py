...
from diffusers_spatialgen.models.mvmm_attention import BasicMVMMTransformerBlock


# Copied from diffusers.models.transformers.transformer_2d.Transformer2DModel
# The only modificaitons: `BasicTransformerBlock` -> `BasicMVMMTransformerBlock`
class TransformerMVMM2DModel(LegacyModelMixin, LegacyConfigMixin):
    """
    ...
    _no_split_modules = ["BasicMVMMTransformerBlock"]
    ...
    def __init__(
        ...
        # for multi-view multi-modal attention
